                        ...
                        if (snapshot.connectionState ==
                          ...
                          if (pickupDateTime is Timestamp) {
                            ...
                            Duration remainingDuration =
                                now.difference(scheduledDate);
                            Duration remainingTimeDuration =
                            now.difference(scheduledTime);

                            int remainingDay = remainingDuration.inDays;
                            int remainingHour =
                                remainingTimeDuration.inHours.remainder(24);
            ...
            PrimaryButton(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CurrentLocationMapPage()));
              },
